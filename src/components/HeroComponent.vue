...
<template>
<div class="container px-5 sm:px-16 lg:px-44">
    <Header />
      ...
      <div class="relative flex flex-col items-start w-full max-w-xl px-4 mx-auto md:px-0 lg:px-8 lg:max-w-screen-xl">
        <div class="mb-16 lg:my-40 lg:max-w-lg lg:pr-5">
          ...
          <p ref="contentP" class="pr-5 mb-5 text-base text-gray-700 md:text-lg">
            There are many packages more than you needed just to make sure that you get enough options to avail the best
            one
          </p>
          ...
          >
            <div class="flex text-left">
              <div class="mr-3 flex items-center justify-center w-7 h-7 text-black transition duration-300 transform rounded-full">
                <img src="../assets/illustrations/Location.png" alt="Location" />
              </div>
              <div class="flex flex-col">
                <div class="text-sm font-semibold">Where to?</div>
            ...
            <div class="flex text-left">
              <div class="mr-3 flex items-center justify-center w-5 h-5 text-black transition duration-300 transform rounded-full">
            ...
            <div class="ml-10 flex items-center justify-center w-10 h-10 text-black transition duration-300 transform rounded-full bg-[#F43F5E]">
