    ...
    <div class="row">
        ...
        <div class="mt-4 col-lg-4 col-md-6 col-sm-6 col-6">
            <div class="input-group btn-custom">
                ...
                <button type="button" class=" btn btn-outline-primary " style="margin-top: 0px; height:30px;" data-mdb-ripple-init>Search</button>
            </div>
        </div>
        <!-- Login and Accounts -->
        <div class="mt-1 col-lg-4 col-md-12 col-sm-12 col-12">
